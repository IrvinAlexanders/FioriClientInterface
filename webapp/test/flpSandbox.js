		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Client List",
									"targetURL": "#group724bcclients-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"group724bcclients-display": {
								"semanticObject": "group724bcclients",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=group724bc.clients",
									"url": sap.ui.require.toUrl("group724bc/clients")
								}
							}
						}
					}
